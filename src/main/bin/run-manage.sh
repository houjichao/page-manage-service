...
FILE_PATH=
SERVER_NAME=page-manage-service
...
readonly APP_MAIN_CLASS="page-manage-service.jar"
...
readonly JAVA_OPTS="-server -Xms256m -Xmx1024m -XX:PermSize=128M -XX:MaxPermSize=256M $JAVA_RUN"
